...
public class ImagePickerSheetController: UIViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIViewControllerTransitioningDelegate {
    ...
    private func requestImageForAsset(asset: PHAsset, size: CGSize? = nil, deliveryMode: PHImageRequestOptionsDeliveryMode = .opportunistic, completion: (_ image: UIImage?) -> Void) {
    ...
    public func getSelectedImagesWithCompletion(completion: (_ images:[UIImage?]) -> Void) {
        var images = [UIImage?]()
